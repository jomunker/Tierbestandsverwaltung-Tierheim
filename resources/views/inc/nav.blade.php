<nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <a class="navbar-brand" href="/Tierbestandsverwaltung/public">Tierheim XY</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="d-flex navbar-nav mr-auto justify-content-end">
        ...
        <li class="nav-item align-items-end">          
          <a class="nav-link" href="/Tierbestandsverwaltung/public/create-animal">Tier Hinzufügen</a>
        </li>
        <li class="nav-item align-items-end">          
